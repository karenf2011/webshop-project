...
<head>
  ...
  <link href="{{ asset('css/webshop-a93ebe.webflow.css') }}" rel="stylesheet" type="text/css">
    ...
    <div class="div-block">
      ...
      <div class="div-block-67">
        <div class="form-block-3 w-form">
          <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="form-2"><input type="email" class="text-field-3 w-input" maxlength="256" name="email-3" data-name="Email 3" placeholder="Search" id="email-3" required=""></form>
        ...
        </div><img src="/images/magnifier.svg" loading="lazy" width="27" data-w-id="1a14cda4-99b7-9f49-27ae-dd14b965f0d2" alt="" class="image-16 mobile">
      </div>
      <div class="navicons"><img src="/images/user.svg" loading="lazy" width="50" data-w-id="b84c3572-0a77-0be8-b4e9-2fd313b3b2c2" alt="" class="image-2">
        <a href="#" class="cartblock w-inline-block"><img src="/images/shopping-cart.svg" loading="lazy" alt="" class="image"></a>
      </div>
      <div data-hover="false" data-delay="0" class="dropdown-3 w-dropdown">
        <div class="dropdown-toggle-5 w-dropdown-toggle"><img src="/images/meat.svg" loading="lazy" width="43" alt="" class="image-9"></div>
